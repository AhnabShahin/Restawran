                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 43px">welcome to our mantanence group,
                                                                 {{ $data['name']}}!&nbsp;</span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Please verify your email
                                                                    ...
                                                                    get access to thousands of exclusive foods
                                                                    listings</span><span
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#ffbe00"
                                                                      ...
                                                                      <a href=" {{ route('admin.account_verification',$data['verification_slug'])}}"
                                                                        ...
                                                                        target="_blank"><strong>Verify Email Now</strong></a>
                                                                    </td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
