                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <img src="{{ $message->embed('main/images/resturant.png')}}" alt="">
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 20px">Welcome to our mantanence group. Your Registration name is {{ $data['name']}}
                                                                 &nbsp;</span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px"><span
                                                                    ...
                                                                    Here is your account password reset link to get access to thousands of exclusive foods
                                                                    listings</span><span
                                                                    style="font-size: 18px">.</span></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #ee0047; font-size: 18px"><strong>Thank
                                                                      you!&nbsp;</strong></span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#ffbe00"
                                                                      ...
                                                                      <a href=" {{ route('admin.reset',$data['password_reset_slug'])}}"
                                                                        style="background-color:#ff77a0; border:2px solid; border-color:#ee0047; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                        target="_blank"><strong>Reset Now</strong></a>
                                                                    </td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                      ...
                                      <div data-role="module-unsubscribe" class="module" role="module"
                                        ...
                                        <div class="Unsubscribe--addressLine">
                                          ...
                                          <p style="font-size:12px; line-height:20px;"><span
                                              class="Unsubscribe--senderAddress">Restawarn Address</span>, <span
                                              class="Unsubscribe--senderCity">Restawarn city</span>, <span
                                              class="Unsubscribe--senderState">Restawarn State</span> <span
                                              class="Unsubscribe--senderZip"?> Restawarn >Zip</span></p>
                                        </div>
                                        <p style="font-size:12px; color:#ee0047;line-height:20px;"><a
                                            class="Unsubscribe--unsubscribeLink" href="#"
                                            target="_blank" style=" color:#ee0047;">Unsubscribe</a> - <a
                                            href="#" target="_blank"
                                            class="Unsubscribe--unsubscribePreferences" style=" color:#ee0047;">Unsubscribe
                                            Preferences</a></p>
                                      </div>
                                      <table border="0" cellpadding="0" cellspacing="0" class="module"
                                        data-role="module-button" data-type="button" role="module"
                                                  ...
                                                  <tr>
                                                    <td align="center" bgcolor="#f5f8fd" class="inner-td"
                                                      ...
                                                      <a href="https://sendgrid.com/"
                                                        ...
                                                        target="_blank">Sended by "Restawarn"</a></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </td>
